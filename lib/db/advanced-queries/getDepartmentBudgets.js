 ...
 * `LEFT JOIN roles` ensures we include any department without roles, or without employees
 * `INNER JOIN employees` ensures we don't include extra data, ie a role without an employee
